<div class="page-home row-content am-cf">
    ...
    <div class="row">
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12 am-margin-bottom">
            <div class="widget am-cf">
                <div class="widget-head">
                    <div class="widget-title">服务支持</div>
                </div>
                <div class="widget-body am-cf">
                    <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                        <div class="widget-outline dis-flex flex-y-center">
                            ...
                            <div class="outline-right dis-flex flex-dir-column flex-x-between">
                                <div style="color: rgb(102, 102, 102); font-size: 1.3rem;">系统版本</div>
                                <div style="color: rgb(153, 153, 153); font-size: 1.2rem;">
                                    <?= $version; ?></div>
                            </div>
                        </div>
                    ...
                    <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                        <div class="widget-outline dis-flex flex-y-center">
                            ...
                            <div class="outline-right dis-flex flex-dir-column flex-x-between">
                                <div style="color: rgb(102, 102, 102); font-size: 1.3rem;">到期时间</div>
                                <div style="color: rgb(153, 153, 153); font-size: 1.2rem;">
                                    <?= date('Y-m-d H:i:s',$store['wxapp']['expire_time']); ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                        <div class="widget-outline dis-flex flex-y-center">
                            ...
                            <div class="outline-right dis-flex flex-dir-column flex-x-between">
                                <a href="http://apps.wsdns.cn/uz4f" style="color: rgb(102, 102, 102); font-size: 1.2rem;">APP下载</a>
                    ...
                    <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                        <div class="widget-outline dis-flex flex-y-center">
                            ...
                            <div class="outline-right dis-flex flex-dir-column flex-x-between">
                                <a href="https://developer.wsdns.cn/index.php?s=/store/setting.workorder/add" style="color: rgb(102, 102, 102); font-size: 1.3rem;">提交工单</a>
                                <div style="color: rgb(153, 153, 153); font-size: 1.2rem;">
                                    售后服务</div>
                            </div>
                        </div>
